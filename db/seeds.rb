...
# Shop.create(merchant_id: 1, description: "Online Vintage Clothing Store. Everything from vintage dresses to sequins tops, menswear and some handmade and reworked items too. Check out www.turquoiseflamingo.com", name: 'Turquoise Flamingo',url:'www.turquoiseflamingo.com', logo:'turquoise.png', address: 'This house')
